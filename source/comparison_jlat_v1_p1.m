...
AX=legend('\textbf{Path 1}','Path 2','Path 3','Path 4','Path 5','Location','southwest');
...
Beta = ['$\beta =$ ' ,num2str(betabad),char(10),'$\beta_{prio} = $ ' ,num2str(betagood)];
...
print(fig,'delay_routing_mixed_path1','-depsc','-r0')
